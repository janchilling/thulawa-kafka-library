...
public class LowPriorityThulawaThreadPool {

    private static final Logger logger = LoggerFactory.getLogger(LowPriorityThulawaThreadPool.class);

    // Prefix for threads in this pool
    public static final String THULAWA_THREAD_NAME = "LowPriorityThulawaThread-%d";
     ...
     */
    public LowPriorityThulawaThreadPool(int poolSize, int queueSize) {
        ...
        logger.info("LowPriorityThulawaThread initialized with poolSize: {} and queueSize: {}", poolSize, queueSize);
    }
